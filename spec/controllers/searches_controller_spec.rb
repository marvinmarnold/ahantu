...
describe SearchesController do
  ...
  let(:valid_attributes) { { "keyword" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested search" do
        ...
        Search.any_instance.should_receive(:update).with({ "keyword" => "MyString" })
        put :update, {:id => search.to_param, :search => { "keyword" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the search as @search" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Search.any_instance.stub(:save).and_return(false)
        put :update, {:id => search.to_param, :search => { "keyword" => "invalid value" }}, valid_session
        assigns(:search).should eq(search)
      end
